...
#'
#' This example data include methylation levels on a region with 208 CpGs for
#' 116 blood samples.
#'
#' @format A data frame of 6064 rows and 13 columns. Each row represents a CpG
...
#'  \item{ACPA4}{binary indicator for a biomarker anti-citrullinated protein
#'  antibody}
#'  \item{Age}{Age}
...
#' }
#' @source simulation is based a real data set provided by PI Dr. Sasha 
#' Bernatsky (McGill University)
"RAdat2"
